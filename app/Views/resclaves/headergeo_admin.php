...
<nav class="navbar navbar-expand-lg ">
	<a class="navbar-brand" href="<?= site_url()."map_admin" ?>">Accueil</a>
  <a class="navbar-brand" href="<?= site_url()."recits_admin" ?>">Liste des récits</a>
</nav>

<h1 class=tprinc> Slave narratives(Administrator) </h1>
